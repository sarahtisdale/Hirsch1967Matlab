...
% Last Modified by GUIDE v2.5 08-Feb-2016 23:41:59
...
V_0         = str2double(handles.EditV0.String);
epsilon_0   = 8.854187817620e-12;
K_e         = 1/(4*pi*epsilon_0);

% Modify K+ by K_e/abs(V_0) for Si units
K_plus = K_plus * K_e / abs(V_0);
...
% --- Executes on slider movement.
function SliderV0_Callback(hObject, eventdata, handles)
% hObject    handle to SliderV0 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
str = sprintf('%d',get(hObject,'Value'));
set(handles.EditV0, 'String', str);
replot_figs(handles);


% --- Executes during object creation, after setting all properties.
function SliderV0_CreateFcn(hObject, eventdata, handles)
% hObject    handle to SliderV0 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
EditCB(hObject,handles.SliderV0);
fig3_new_radius(handles);
replot_figs(handles);
